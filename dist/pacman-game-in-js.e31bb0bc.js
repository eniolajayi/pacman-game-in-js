...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExist) {
      var nextMovePosition = this.position + this.direction.movement;
...
var _default = Pacman;
exports.default = _default;
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js"}],"ghostMove.js":[function(require,module,exports) {
"use strict";
...
function randomMovement(position, direction, objectExist) {
  var dir = direction;
  var nextMovePosition = position + dir.movement; // Create an array from the diretions objects keys

  var keys = Object.keys(_setup.DIRECTIONS);

  while (objectExist(nextMovePosition, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovePosition, _setup.OBJECT_TYPE.GHOST)) {
...
var Ghost = /*#__PURE__*/function () {
  function Ghost() {
    ...
    this.position = startPosition;
    this.direction = _setup.DIRECTIONS.ArrowRight;
    this.speed = speed;
    this.timer = 0;
    this.isScared = false;
    this.rotation = false;
  ...
  (0, _createClass2.default)(Ghost, [{
    ...
    key: "getNextMove",
    value: function getNextMove(objectExist) {
      var _this$movement = this.movement(this.position, this.direction, objectExist),
...
var _default = Ghost;
exports.default = _default;
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./setup":"setup.js","./ghostMove":"ghostMove.js"}],"audio/munch.wav":[function(require,module,exports) {
module.exports = "/munch.bd4280c6.wav";
},{}],"audio/pill.wav":[function(require,module,exports) {
module.exports = "/pill.5b081178.wav";
},{}],"audio/game_start.wav":[function(require,module,exports) {
module.exports = "/game_start.7bc47738.wav";
},{}],"audio/death.wav":[function(require,module,exports) {
module.exports = "/death.64c0ca81.wav";
},{}],"audio/eat_ghost.wav":[function(require,module,exports) {
module.exports = "/eat_ghost.1b3bdb73.wav";
...
var _munch = _interopRequireDefault(require("./audio/munch.wav"));

var _pill = _interopRequireDefault(require("./audio/pill.wav"));

var _game_start = _interopRequireDefault(require("./audio/game_start.wav"));

var _death = _interopRequireDefault(require("./audio/death.wav"));

var _eat_ghost = _interopRequireDefault(require("./audio/eat_ghost.wav"));
...
var gameBoard = _GameBoard.default.createGameBoard(gameGrid, _setup.LEVEL); // Initial setups
...
function gameLoop(pacman, ghosts) {
  ...
  checkCollision(pacman, ghosts); // check pacman eats a dot

  if (gameBoard.objectExist(pacman.position, _setup.OBJECT_TYPE.DOT)) {
  ...
  if (gameBoard.objectExist(pacman.position, _setup.OBJECT_TYPE.PILL)) {
...
},{"./setup":"setup.js","./GameBoard":"GameBoard.js","./Pacman":"Pacman.js","./ghostMove":"ghostMove.js","./Ghost":"Ghost.js","./audio/munch.wav":"audio/munch.wav","./audio/pill.wav":"audio/pill.wav","./audio/game_start.wav":"audio/game_start.wav","./audio/death.wav":"audio/death.wav","./audio/eat_ghost.wav":"audio/eat_ghost.wav"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/pacman-game-in-js.e31bb0bc.js.map